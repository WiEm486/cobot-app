...
const Sidebar = ({ open, onClose }) => {
  return (
    ...
    >
      ...
      <div className={`mx-[14px] mt-[30px] flex items-center`}>
        <div className="flex items-center">
          <img src={logo} alt="Logo Enova Robotics" className="h-12 w-12 mt-5" />
          <div className="mt-1 ml-1 h-1.5 font-poppins text-[20px] font-bold uppercase text-navy-700 dark:text-white">
            Enova <span className="font-medium">Robotics</span>
          </div>
        </div>
      </div>
